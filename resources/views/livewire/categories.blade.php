    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><a href="#" class="link">Category</a></li>
                <li class="item-link"><span>{{$catName}}</span></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">{{$catName}}</h1>
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model="perPage">
                                <option value="6">6 per page</option>
                                <option value="9">8 per page</option>
                        ...
                        <ul class="list-category">
                            @foreach($categories as $cat)
                                <li class="category-item">
                                    <a href="{{route('category',$cat->slug)}}" class="cate-link">{{$cat->name}}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
